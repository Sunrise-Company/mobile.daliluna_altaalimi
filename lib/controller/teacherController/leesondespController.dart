...
class TeacherLessonDespsContrlloer extends GetxController {
  ...
  Future<void> getSudenteLesson() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          AppLink.server +
              '/app_teacher_lesson_deps/${teacher_id.toString()}/${Get.arguments['id'].toString()}',
        ),
      );
      ...
      if (response.statusCode == 200) {
        ...
        dataList.value = responseData['lesson_deps'];
