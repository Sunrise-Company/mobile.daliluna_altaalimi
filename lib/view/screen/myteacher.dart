...
class MyTeacher extends GetView<TeacherController> {
  MyTeacher({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        //         ? controller.myTeachers.isNotEmpty
        ...
        //                           ),
        //                           shrinkWrap: true,
        //                           itemCount: controller.myTeachers.length,
                    ...
                    ? AnimationLimiter(
                        child: GlowingOverscrollIndicator(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount: controller.myTeachers.length,
                            itemBuilder: (context, index) {
                              final teacher = controller.myTeachers[index];
                              ...
                              //           ),
                              //           shadowColor: AppColor.SecondryColor.withOpacity(0.5),
                              //           child: Column(
                              //             children: [
                              //               Expanded(
                              //                 flex: 3,
