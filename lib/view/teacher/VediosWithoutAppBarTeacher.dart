...
class _YoutubeVideoCardState extends State<YoutubeVideoCard> {
  ...
  String _formatIso8601Duration(String iso) {
    ...
    return VediosWithoutAppBarTeacher([], false)._formatDuration(totalSeconds);
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<String>(
      ...
      builder: (context, snapshot) {
        ...
        return VediosWithoutAppBarTeacher([], false)._buildCardLayout(
          ...
          thumbnail: _videoId == null
              ...
              : Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) {
                    return VediosWithoutAppBarTeacher(
                      [],
                      false,
                    )._buildDefaultThumbnail(context);
                  },
