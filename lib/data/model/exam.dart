...
String qeustions_one;
  QuizFile({required this.qeustions,required this.answer,required this.type,
  required this.qeustions_one,
  required this.content,required this.type_answer, required  this.correct_order});
} 
List<QuizFile>  qeustions= [
    ...
    "طبقة الإيثرنت "
              ...
              QuizFile(
                  ...
                  answer: ["o(n)   ", " o(n^2)  ", " O(5)  "],correct_order: [
...
Quiz({
 ...
 required this.date,required this.statuse,required this.qeustions
